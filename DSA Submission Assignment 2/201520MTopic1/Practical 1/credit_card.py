# Consider the following class diagram for a CreditCard class 
# and the complete implementation of a Python CreditCard class 
...
class CreditCard:
    ...
    def __init__(self, customer, bank, acnt, limit): 
        ...
        acnt the acount identifier (e.g., '5391 0375 9387 5309') limit credit limit (measured in dollars)
        """
